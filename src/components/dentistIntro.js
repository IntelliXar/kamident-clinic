export default function DentistIntro() {
	return (
	  <section className="flex flex-col md:flex-row gap-6 justify-between p-5 max-w-[800px] mx-[auto]">
		<div className="w-full md:w-[70%] px-4 border-b border-gray-500 md:border-b-0 md:border-r">
